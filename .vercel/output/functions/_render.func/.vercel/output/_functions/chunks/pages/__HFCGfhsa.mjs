...
async function getSession(req, options = authConfig) {
  options.secret ??= Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://www.veracines.es", "ASSETS_PREFIX": undefined}, { NODE: process.env.NODE, _: process.env._, NODE_ENV: process.env.NODE_ENV }).AUTH_SECRET;
