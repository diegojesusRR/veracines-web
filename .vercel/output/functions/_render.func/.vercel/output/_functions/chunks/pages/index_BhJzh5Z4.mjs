...
const $$SiguientePelicula = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$SiguientePelicula;
  return renderTemplate`${maybeRenderHead()}<div> <img src="/img/siguiente-pelicula.jpeg"> </div>`;
}, "/Users/diego.ramos/veracines-web/src/components/siguientePelicula.astro", void 0);
