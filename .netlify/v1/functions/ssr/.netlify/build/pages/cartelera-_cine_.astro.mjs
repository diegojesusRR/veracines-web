/* empty css                                       */
import { f as createAstro, g as createComponent, m as maybeRenderHead, i as addAttribute, r as renderTemplate, j as renderComponent, u as unescapeHTML, k as Fragment } from '../chunks/astro/server_CE9mvu6d.mjs';
import 'kleur/colors';
import { a as $$Layout } from '../chunks/Layout_DgNdm22p.mjs';
import { G as GRUPOSPROYECCIONES, C as CINES } from '../chunks/proyecciones_bbn_-8p5.mjs';
...
Proyecciones ${mesesProyeccion.length > 0 ? `- ${mesesProyeccion.map((x) => MESES[x]).join(" y ")}` : ""} </h4> ${!tieneProyecciones ? renderTemplate`<div class="sin-proyecciones p-3 rounded-lg" data-astro-cid-3vwqciy3> <p class="font-semibold" data-astro-cid-3vwqciy3>Actualmente no hay proyecciones disponibles.</p> </div>` : renderTemplate`<div class="grid grid-cols-2 lg:grid-cols-4 gap-2" data-astro-cid-3vwqciy3> ${diasProyeccion.sort().map((diaProyeccion) => {
    ...
    return renderTemplate`<div class="rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 py-2 text-center" data-astro-cid-3vwqciy3> <p class="dia-label font-bold text-md leading-tight" data-astro-cid-3vwqciy3>${diaLabel}</p> <p class="text-sm text-gray-700 dark:text-gray-300 mt-1 leading-tight" data-astro-cid-3vwqciy3>${horas}</p> </div>`;
  })} </div>`} </section> <section class="px-4 sm:px-5 pb-4" data-astro-cid-3vwqciy3> <div class="mb-4" data-astro-cid-3vwqciy3> <span class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-1.5" data-astro-cid-3vwqciy3> <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5" data-astro-cid-3vwqciy3> <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" data-astro-cid-3vwqciy3></path> </svg>
Sinopsis
</span> <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed line-clamp-3 mb-1.5" data-astro-cid-3vwqciy3> ${pelicula.descripcion} </p> </div> <div class="flex flex-col sm:flex-row gap-2" data-astro-cid-3vwqciy3> ${entradasLink && tieneProyecciones && renderTemplate`${renderComponent($$result, "Action", $$Action, { "as": "a", "class": "flex-1 justify-center", "aria-label": `Enlace a los tickets de ${cine.nombre} para la pelicula ${pelicula.nombre}`, "href": entradasLink, "color": cine.color, "target": "_blank", "data-astro-cid-3vwqciy3": true }, { "default": ($$result2) => renderTemplate`
Entradas
...
const $$Cartelera = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$Cartelera;
  const { cine } = Astro2.props;
  const now = /* @__PURE__ */ new Date();
  const BASE_URL = "https://www.veracines.es";
  const gruposCine = GRUPOSPROYECCIONES.filter((g) => g.cine.url === cine.url).filter((g) => g.proyecciones.some((p) => p.fecha >= now));
  const movieEvents = gruposCine.map((g) => {
    const proximas = g.proyecciones.filter((p) => p.fecha >= now).sort((a, b) => a.fecha.getTime() - b.fecha.getTime());
    return {
      "@type": "ScreeningEvent",
...
}, "/Users/diego.ramos/veracines-web/src/components/SEO/cartelera.astro", void 0);
...
</p> </div> </div>`} </section> <section data-astro-cid-atfez4uf> ${renderComponent($$result2, "ProyeccionesCine", $$ProyeccionesCine, { "cine": cine, "data-astro-cid-atfez4uf": true })} </section> </main> `, "head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "CartelleraSEO", $$Cartelera, { "cine": cine, "data-astro-cid-atfez4uf": true })} ` })}` })} `;
