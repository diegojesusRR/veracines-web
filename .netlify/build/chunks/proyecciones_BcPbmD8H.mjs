...
const CINES = [
  {
    ...
    ventaOnline: false,
    horario: {
      fechaInicio: `${(/* @__PURE__ */ new Date()).getFullYear()}-06-23`,
      fechaFin: `${(/* @__PURE__ */ new Date()).getFullYear()}-09-10`,
  ...
  },
  {
    ...
    ventaOnline: true,
    horario: {
      fechaInicio: `${(/* @__PURE__ */ new Date()).getFullYear()}-10-01`,
      fechaFin: `${(/* @__PURE__ */ new Date()).getFullYear() + 1}-05-01`,
...
const gruposProyeccionesVera = [
  ...
  },
  {
    ...
    pelicula: PELICULAS.find((pelicula) => pelicula.id === "minions-and-monsters"),
    proyecciones: [
      ...getProyecciones(/* @__PURE__ */ new Date("2026-07-21"), /* @__PURE__ */ new Date("2026-07-23"), "22:00")
    ]
  },
  {
    grupo: 10,
    ...
    proyecciones: [
      ...getProyecciones(/* @__PURE__ */ new Date("2026-07-24"), /* @__PURE__ */ new Date("2026-07-27"), "22:00")
    ]
  },
  {
    grupo: 11,
    ...
    pelicula: PELICULAS.find((pelicula) => pelicula.id === "toy-story-5"),
    proyecciones: [
      ...getProyecciones(/* @__PURE__ */ new Date("2026-07-28"), /* @__PURE__ */ new Date("2026-07-30"), "22:00")
    ]
  },
  {
    grupo: 12,
...
export { CINES as C, GRUPOSPROYECCIONES as G, PELICULAS as P };
