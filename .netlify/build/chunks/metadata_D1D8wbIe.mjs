import { f as createAstro, g as createComponent, j as renderComponent, r as renderTemplate, m as maybeRenderHead, k as renderSlot } from './astro/server_DfvI8eY9.mjs';
import 'kleur/colors';
/* empty css                         */
...
const $$Action = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Action;
  const { as: Tag, class: className, color = "primary", ...props } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Tag", Tag, { "class:list": [
    "action-btn",
    "aria-disabled:pointer-events-none aria-disabled:opacity-40",
    className
  ], "style": `--btn-color: var(--color-${color})`, ...props, "data-astro-cid-gmcsra3q": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<span class="action-btn__label" data-astro-cid-gmcsra3q>${renderSlot($$result2, $$slots["default"])}</span> ` })} `;
