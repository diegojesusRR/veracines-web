/* empty css                                       */
import { g as createComponent, m as maybeRenderHead, j as renderComponent, r as renderTemplate, f as createAstro, i as addAttribute, s as spreadAttributes, l as renderSlot, u as unescapeHTML, k as Fragment } from '../chunks/astro/server_CE9mvu6d.mjs';
import 'kleur/colors';
import { a as $$Layout } from '../chunks/Layout_DgNdm22p.mjs';
import { $ as $$Action, M as Metadata } from '../chunks/metadata_CwD_cYt4.mjs';
/* empty css                                 */
import { C as CINES, G as GRUPOSPROYECCIONES } from '../chunks/proyecciones_bbn_-8p5.mjs';
import 'clsx';
...
Cine de verano en<br> <span class="text-secondary">Vera, Almería</span> </h1> <p class="text-gray-600 dark:text-gray-400 text-base leading-relaxed">
...
const $$UbicacionCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="ubicacion-card rounded-2xl overflow-hidden shadow-lg bg-white dark:bg-gray-900 transition-shadow hover:shadow-2xl"${addAttribute(`--cine-color: var(--color-${cine.color})`, "style")}${addAttribute(`${cine.url}`, "id")} data-astro-cid-ntj7ie3s> <!-- Franja superior de color --> <div class="ubicacion-header h-2 w-full" data-astro-cid-ntj7ie3s></div> <div class="flex flex-col lg:flex-row" data-astro-cid-ntj7ie3s> <!-- Info --> <div class="flex flex-col gap-4 p-6" data-astro-cid-ntj7ie3s> <!-- Título + botón debajo --> <div class="flex flex-col gap-3" data-astro-cid-ntj7ie3s> <div data-astro-cid-ntj7ie3s> <h4 class="ubicacion-title text-xl font-extrabold leading-tight mb-1" data-astro-cid-ntj7ie3s> ${cine.nombre} </h4> </div> ${renderComponent($$result, "Action", $$Action, { "class": "w-full sm:w-fit", "color": cine.color, "as": "a", "href": `/cartelera-${cine.url}/`, "aria-label": `Enlace a la cartelera de ${cine.nombre}`, "data-astro-cid-ntj7ie3s": true }, { "default": ($$result2) => renderTemplate`
🎬 Ver cartelera
` })} </div> <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed" data-astro-cid-ntj7ie3s> ${cine.localizacion.descripcion} </p> <!-- Mapa --> <div class="min-h-[220px] overflow-hidden" data-astro-cid-ntj7ie3s> <iframe class="w-full h-full min-h-[220px]"${addAttribute(`https://www.google.com/maps/embed?pb=${cine.localizacion.ubicacionKey}`, "src")} width="600" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"${addAttribute(`Mapa de ${cine.nombre}`, "title")} data-astro-cid-ntj7ie3s></iframe> </div> <!-- Detalles rápidos --> <ul class="flex flex-col gap-2 text-sm mt-auto" data-astro-cid-ntj7ie3s> <li class="flex items-start gap-2 text-gray-500 dark:text-gray-400" data-astro-cid-ntj7ie3s> <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-astro-cid-ntj7ie3s> <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" data-astro-cid-ntj7ie3s></path> </svg> <span data-astro-cid-ntj7ie3s>${cine.localizacion.direccion}</span> </li> ${cine.horaFijaProyeccion && renderTemplate`<li class="flex items-center gap-2 text-gray-500 dark:text-gray-400" data-astro-cid-ntj7ie3s> <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-astro-cid-ntj7ie3s> <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-astro-cid-ntj7ie3s></path> </svg> <span data-astro-cid-ntj7ie3s>Proyecciones a las <strong data-astro-cid-ntj7ie3s>${cine.horaFijaProyeccion}h</strong></span> </li>`} <li class="flex items-center gap-2 text-gray-500 dark:text-gray-400" data-astro-cid-ntj7ie3s> <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-astro-cid-ntj7ie3s> <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" data-astro-cid-ntj7ie3s></path> </svg> <span data-astro-cid-ntj7ie3s>Venta online: <strong data-astro-cid-ntj7ie3s>${cine.ventaOnline ? "Disponible" : "No disponible"}</strong></span> </li> </ul> </div> </div> </div> `;
...
const $$Ubicaciones = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section aria-labelledby="ubicaciones-titulo" class="flex flex-col gap-6"> <div class="text-center space-y-2"> <h2 id="ubicaciones-titulo" class="text-2xl font-extrabold text-primary">
...
</h2> <p class="text-gray-500 dark:text-gray-400 text-sm max-w-sm mx-auto">
Estamos encantados de ayudarte. Elige el canal que prefieras.
</p> </div> <div class="grid grid-cols-1 sm:grid-cols-3 gap-3"> <a${addAttribute(`tel:${tel}`, "href")} class="contact-card group flex sm:flex-col items-center gap-4 sm:gap-3 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm p-4 sm:p-6 sm:text-center transition-all duration-200 hover:shadow-md hover:-translate-y-1 hover:border-primary/30 dark:hover:border-primary/40"${addAttribute(`Llamar al ${CONTACTO.telefono.numero}`, "aria-label")}> <div class="contact-icon text-primary shrink-0 transition-transform duration-200 group-hover:scale-110"> ${renderComponent($$result, "Phone", $$Phone, { "class": "w-8 h-8" })} </div> <div class="min-w-0"> <p class="text-sm font-bold text-gray-700 dark:text-gray-200">Teléfono</p> <p class="text-xs text-gray-400 dark:text-gray-500 truncate">${CONTACTO.telefono.numero}</p> </div> <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-primary ml-auto sm:hidden transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"> <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"></path> </svg> </a> <a${addAttribute(wa, "href")} target="_blank" rel="noopener noreferrer" class="contact-card group flex sm:flex-col items-center gap-4 sm:gap-3 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm p-4 sm:p-6 sm:text-center transition-all duration-200 hover:shadow-md hover:-translate-y-1 hover:border-green-300 dark:hover:border-green-700" aria-label="Contactar por WhatsApp"> <div class="contact-icon text-[#25D366] shrink-0 transition-transform duration-200 group-hover:scale-110"> ${renderComponent($$result, "Whatsapp", $$Whatsapp, { "class": "w-8 h-8" })} </div> <div class="min-w-0"> <p class="text-sm font-bold text-gray-700 dark:text-gray-200">WhatsApp</p> <p class="text-xs text-gray-400 dark:text-gray-500">${CONTACTO.telefono.numero}</p> </div> <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-green-400 ml-auto sm:hidden transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"> <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"></path> </svg> </a> <a${addAttribute(`mailto:${CONTACTO.email}`, "href")} class="contact-card group flex sm:flex-col items-center gap-4 sm:gap-3 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm p-4 sm:p-6 sm:text-center transition-all duration-200 hover:shadow-md hover:-translate-y-1 hover:border-primary/30 dark:hover:border-primary/40"${addAttribute(`Enviar email a ${CONTACTO.email}`, "aria-label")}> <div class="contact-icon text-primary shrink-0 transition-transform duration-200 group-hover:scale-110"> ${renderComponent($$result, "Email", $$Email, { "class": "w-8 h-8" })} </div> <div class="min-w-0"> <p class="text-sm font-bold text-gray-700 dark:text-gray-200">Email</p> <p class="text-xs text-gray-400 dark:text-gray-500 truncate">${CONTACTO.email}</p> </div> <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-primary ml-auto sm:hidden transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"> <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"></path> </svg> </a> </div> </section>`;
...
</h2> <p class="text-gray-500 dark:text-gray-400 text-sm max-w-md mx-auto">
...
const $$Home = createComponent(($$result, $$props, $$slots) => {
  const schemaOrg = CINES.map((cine) => ({
    "@type": "MovieTheater",
    "@id": `https://www.veracines.es/#${cine.url}`,
  ...
  const organizationGraph = [{
    "@type": "Organization",
    "@id": "https://veracines.es/#organizacion",
    "name": "Veracines",
    "url": "https://veracines.es/",
    "logo": "https://veracines.es/img/veracines-logo.png",
    "sameAs": [
      "https://www.facebook.com/veracines.es",
      "https://www.instagram.com/veracines.sl"
    ],
    "subOrganization": [
      { "@id": "https://veracines.es/#vera" },
      { "@id": "https://veracines.es/#regio" }
    ]
  }];
  const graph = [...organizationGraph, ...schemaOrg];
  return renderTemplate(_a || (_a = __template(['<script type="application/ld+json">', "<\/script>"])), unescapeHTML(JSON.stringify({
    "@context": "https://schema.org",
    "@graph": graph
  })));
}, "/Users/diego.ramos/veracines-web/src/components/SEO/home.astro", void 0);

const prerender = false;
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "description": Metadata.home.description, "title": Metadata.home.title, "canonical": Metadata.home.canonical }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<main class="max-w-3xl mx-auto px-4"> <div class="grid gap-14"> ${renderComponent($$result2, "Hero", $$Hero, {})} ${renderComponent($$result2, "ProximasProyeccionesCarousel", $$ProximasProyeccionesCarousel, {})} ${renderComponent($$result2, "Ubicaciones", $$Ubicaciones, {})} ${renderComponent($$result2, "Servicios", $$Servicios, {})} ${renderComponent($$result2, "Contacto", $$Contacto, {})} </div> </main> `, "head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "HomeSEO", $$Home, {})} ` })}` })}`;
